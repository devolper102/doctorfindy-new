...
{
    const RoleAttendee = 1;
    const RolePublisher = 2;
    const RoleSubscriber = 3;
    const RoleAdmin = 101;
    ...
    public static function buildTokenWithUid($appId, $appCertificate, $channelName, $uid, $role, $privilegeExpiredTs)
    {
        ...
        $token->addPrivilege(AccessToken::Privileges["kJoinChannel"], $privilegeExpiredTs)
            ->addPrivilege(AccessToken::Privileges["kPublishAudioStream"], $privilegeExpiredTs)
            ->addPrivilege(AccessToken::Privileges["kPublishVideoStream"], $privilegeExpiredTs)
            ->addPrivilege(AccessToken::Privileges["kPublishDataStream"], $privilegeExpiredTs);
