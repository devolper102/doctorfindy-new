    ...
    <div class="row">
                   ...
                   <div class="dc-dashboardbox">
                        <div class="dc-dashboardboxtitle dc-titlewithsearch dc-titlewithdel">
                            <h2>Manage Laboratorys Demo Requests</h2>
                        </div>
                        @if ($laboratoryDemos->count() > 0)
                           <div class="dc-dashboardboxcontent dc-categoriescontentholder">
                                <table  id="vaccination"  class="table table-bordered table-hover dt-responsive nowrap table-responsive"cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($laboratoryDemos as $key => $demo)
                                            <tr>
                                                
                                                <td>{{$demo->name}}</td>
                                                <td>{{$demo->registration_number}}</td>
                                ...
                                @if ( method_exists($laboratoryDemos,'links') )
                                    {{ $laboratoryDemos->links('pagination.custom') }}
                                @endif
                            </div>
                        @else
