                ...
                <div class="wrap-social-icons dc-haslayout">
                    <div class="form-group">
                        <div class="form-group-holder">
                            ...
                            !!}
                            {!! Form::text('social['.$counter.'][icon]', $unserializevalue->icon,
                                ['class' => 'form-control'])
                            !!}
                        </div>
            ...
            <div class="wrap-social-icons dc-haslayout">
                <div class="form-group">
                    <div class="form-group-holder">
                        ...
                        !!}
                         {!! Form::text('social[0][icon]', null, ['class' => 'form-control ',
                            'placeholder' => trans('Social Icon'),'v-model' => 'first_social_icon'])
                        !!}
                    </div>
                    <div class="form-group dc-rightarea">
                ...
                <div class="wrap-social-icons dc-haslayout">
                    <div class="form-group">
                        <div class="form-group-holder">
                            ...
                            <input placeholder="{{{trans('Social Icon')}}}" v-bind:name="'social['+[social.count]+'][icon]'" type="text"
                                class="form-control" v-model="social.social_icon">    
                        </div>
                        <div class="form-group dc-rightarea">
