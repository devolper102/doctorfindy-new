            ...
            <div class="dc-formtheme dc-userform">
                <fieldset>
                    <div class="form-group">
                        {!! Form::text('title', e($doctor_title), ['class' =>
                            'form-control','placeholder'=>trans('lang.ph.title')]) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::text('subtitle', e($doctor_subtitle), ['class' =>
                            'form-control','placeholder'=>trans('lang.ph.sub_heading')]) !!}
                    </div>
                    <div class="form-group form-group-half">
                        {!! Form::text('btn_one_title', e($doctor_btn_one_title), ['class' =>
                            'form-control','placeholder'=>trans('lang.ph.btn_one_title')]) !!}
                    </div>
                    <div class="form-group form-group-half">
                        {!! Form::text('btn_one_url', e($doctor_btn_one_url), ['class' =>
