{!! Form::open(['url' => '', 'class' =>'dc-formtheme dc-userform', 'id'=>'home-services-tabs-form', '@submit.prevent'=>'submitServicesTabSettings']) !!}
    <div class="dc-sectionsettings dc-tabsinfo">
        <div class="dc-tabscontenttitle la-switch-option">
            <h3>{{ trans('Benefits of DoctorFindy') }}</h3>
            ...
            <div class="dc-formtheme dc-userform">
                <fieldset class="service-tab-content">
                    ...
                    @else
                        ...
                        <div class="dc-formtheme dc-userform">
                                 @if (!empty($first_service_tab_img))
                                <upload-media
                                :title="'{{ trans('Side Bar Image') }}'"
                                :img="'{{ $first_service_tab_img }}'"
                                :img_id="'first_service_tab_img'"
                                :img_name="'first_service_tab_img'"
                                :img_ref="'first_service_tab_img'"
                                :img_hidden_name="'hidden_first_service_tab_img'"
                                :img_hidden_id="'hidden_first_service_tab_img'"
                                :existed_img="'{{$first_service_tab_img}}'"
                                :url="'{{ url("media/upload-temp-image/settings/first_service_tab_img") }}'"
                                :existing_img_url="'{{ url("uploads/settings/home/$first_service_tab_img") }}'"
                                :size = "'{{ Helper::getImageDetail( $first_service_tab_img, 'size', 'uploads/settings/home') }}'"
                                :existing_img_name = "'{{ Helper::getImageDetail( $first_service_tab_img, 'name', 'uploads/settings/home') }}'"
                                >
                                </upload-media>
                            @else
                                <upload-media
                                ...
                                :img_hidden_name="'hidden_first_service_tab_img'"
                                :img_hidden_id="'hidden_first_service_tab_img'"
                                :url="'{{ url("media/upload-temp-image/settings/first_service_tab_img/banner_img") }}'"
                                >
                                </upload-media>
                                 @endif
                        </div>
