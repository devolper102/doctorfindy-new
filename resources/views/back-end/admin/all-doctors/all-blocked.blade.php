                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="dc-dashboardbox">
                        <div class="dc-dashboardboxtitle dc-titlewithsearch dc-titlewithdel">
                            <h2>All Blocked Doctors</h2>
                        </div>
                        
                        @if(count($users) > 0)
                            <div class="dc-dashboardboxcontent dc-categoriescontentholder">
                                <table id="all-blocked-doctors" class="table table-striped table-bordered dt-responsive nowrap table-responsive">
                                    <thead>
                                    ...
                                    <tbody >
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                                ...
                                                @if($user_data->status == 1 || $user_data->status == '1' || $user_data->status == 'register')
                           ...
                           <div class="dc-actionbtn ">
                              ...
                              <i class="lnr lnr-pencil"></i>
                                        ...
                                        @if($user_data->location == ''|| $user_data->location == null || $user_data->location == 'null' || $user_data->specialities == null || $user_data->specialities == [] || $user_data->specialities == '')
...
$(document).ready(function() {
      localStorage. setItem('clickCount', 1);
       var table = $('#all-blocked-doctors').DataTable({
        "bDestroy": true,
        "defaultContent": "-",
        "targets": "_all",
        "order": [[12, "desc"]]
      ...
      $(document).on('keyup','.search_field',function(){
            ...
            $.ajax({
               type: "GET",
               url: base+"/all-blocked-doctors-search",
