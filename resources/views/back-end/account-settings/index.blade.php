    ...
    <div class="dc-haslayout dc-manage-account la-setting-holder" id="account_settings">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                ...
                <div class="dc-dashboardbox dc-dashboardtabsholder dc-accountsettingholder">
                 ...
                 {{--            @if (Helper::getAuthRoleType() != 'admin')
                            ...
                            @if(Helper::getAuthRoleType() === 'admin' || Helper::getAuthRoleType() === 'doctor' || Helper::getAuthRoleType() === 'hospital' || Helper::getAuthRoleType() === 'patient')
                                <li class="nav-item">
                                    <a class="{{ Helper::getAuthRoleType() == 'admin' ? 'active' : '' }} active" data-toggle="tab" href="#dc-reset-pass">{{{ trans('lang.reset_pass') }}}</a>
                                </li>
                            @endif
                            @if (Helper::getAuthRoleType() === 'admin')
                                <li class="nav-item">
              ...
              {{--           <div class="dc-securityhold tab-pane la-section-settings {{ Helper::getAuthRoleType() != 'admin' ? 'active' : '' }}" id="dc-delete-account">
                        ...
                        <div class="dc-securityhold tab-pane {{ Helper::getAuthRoleType() === 'admin' ? 'active' : '' }} la-section-settings active" id="dc-reset-pass">
      ...
      <div class="container my-auto">
        <div class="copyright text-center my-auto">
          <span>Copyright &copy; DoctorFindy 2021-22</span>
        </div>
      </div>
    </footer>
        </div>
