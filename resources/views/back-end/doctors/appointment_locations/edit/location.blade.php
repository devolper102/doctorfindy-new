<div class="dc-haslayout">
            ...
            @if($location->doctor_id !== 'online' && $location->user_id !== 'online')
                ...
                <div>
                    <figure class="dc-clinicsimg">
                        <img src="{{ asset(Helper::getImage('uploads/users/'.$location->hospital->id, $location->hospital->profile->avatar, 'small-', 'user.jpg')) }}" alt="{{ trans('lang.img_desc') }}"style="width: 100px;height: 100px;">
                    </figure>
                </div>
    ...
    <form action="{{route('update-consultation-fee')}}" method="post">
        @csrf
        <div>
            <label>Consultation fee</label>
            <input type="text" name="consultation_fee" value="{{ is_array($consultation_fee) ? '' : $consultation_fee }}">
