        ...
        <div class="dc-navigationarea">
            <div class="container-fluid">
                <div class="row">
                    ...
                    @if (Helper::getGeneralSettings('site_logo') == 'true')
                        <strong class="dc-logo"><a href="{{ url('/') }}"><img src="{{ asset(Helper::getGeneralSettings('site_logo')) }}" alt="{{ trans('lang.site_logo') }}"></a> <!-- <a href="{{ url('/') }}"><h5>DoctorFindy</h5></a> --></strong>
