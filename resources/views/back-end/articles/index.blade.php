    ...
    <div class="row la-article-holder" id="articles">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="dc-dashboardbox dc-offered-holder">
                <div class="dc-dashboardboxtitle py-3">
                        ...
                        <div class="dc-contentdoctab dc-articles-holder dc-listedarticle dc-postarticle">
                            <div class="dc-articles">
                                <div class="dc-articleslist-content dc-articles-list">
                                    @php
                                    $auth_user = App\User::where('id',Auth::user()->id)->with('speciality','location')->first();
                                    @endphp
                                        ...
                                        <div class="dc-article del-{{{ $article->id }}}">
                                                    ...
                                                    <figcaption>
                                                        <div class="dc-articlesdocinfo">
                                                            ...
                                                            <span>
                                                                ...
                                                                @else
                                                                    <a href="{{ route('citySpecialtyUserProfile', ['slug' => clean(Auth::user()->slug),'city' =>$auth_user->location->slug,'speciality' =>$auth_user->speciality[0]->slug]) }}"> {{ Helper::getUserName($article->author_id) }}</a>
                                                                @endif
                                                            </span>
                                                        </div>
                                                    </figcaption>
                                            ...
                                            <div class="dc-articlecontent">
                                                <div class="dc-title">
                                                    ...
                                                    @endif
                                                    <h3><a href="{{ route('article-show', ['slug' => $article->slug]) }}">{{ html_entity_decode(clean($article->title)) }}</a></h3>
