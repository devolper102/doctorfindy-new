...
<link rel="stylesheet" rel="preload" type="text/css" href="{{ asset('compiled/product-detail.css') }}" >
  <link rel="stylesheet" type="text/css" href="/css/product-detail-responsive.css">
...
<div id="home">
   ...
   <header-section
    ...
    :similarproducts="{{json_encode($similarProducts,true)}}">
    </product-detail-section>
    {{--Footer Section--}}
    <footer-section
