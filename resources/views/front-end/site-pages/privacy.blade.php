...
@section('title','Terms and Conditions / Privacy Policy - DoctorFindy') 
@section('meta_title','Privacy Policy of DoctorFindy') 
@section('meta_description','Our Privacy Policy your Data | DoctorFindy') 
@section('content')
<link rel="stylesheet" rel="preload" type="text/css" href="{{ asset('compiled/privacy.min.css') }}" >
       @php
