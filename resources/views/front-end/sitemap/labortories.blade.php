...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    @foreach($labortories as $key => $laboratory)
        <url>
            <loc>{{ URL::route("laboratories-city-laboratory-area", [$laboratory->location->slug,  $laboratory->slug]) }}</loc>
            <lastmod>{{ gmdate(DateTime::W3C, strtotime($laboratory->updated_at)) }}</lastmod>
