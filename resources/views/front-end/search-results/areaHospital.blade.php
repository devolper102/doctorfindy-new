...
<div id="search">
    ...
    @php
        ...
        if($area != null)
        {
           if(Request::path() == ('hospitals/'.$location->slug.'/area/'.$area))
            {
                $breadcrumbsdata=Breadcrumbs::generate('hospitals-city-area', $location, $area);
            } 
        }     
        else
        {
            ...
            {
                $breadcrumbsdata=Breadcrumbs::generate('hospitals-city', $location);
            }
            else
            {
                $breadcrumbsdata=[];
         ...
         <div class="search-bg w-100 d-inline-block">
          ...
          <div class="row">
                <div class="col-12 mt-4">
                  {{ Breadcrumbs::render('hospitals-city-area', $location, $area) }}
                </div>
          </div>
      </div>
  </div>
