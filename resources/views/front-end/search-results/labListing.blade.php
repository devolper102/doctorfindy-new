...
<div id="search">
    ...
    @php
        ...
        $keyword = "";
         ...
         if(Request::route()->getName() == "laboratories-location-area")
        {
            $breadcrumbsdata=Breadcrumbs::generate('labs-city-area',$location,$area);
        }
        else if(Request::route()->getName() == "laboratory-by-city")
        {
            $breadcrumbsdata=Breadcrumbs::generate('labs-city', $location);
        }
        else
        {
            $breadcrumbsdata=Breadcrumbs::generate('labs');
        }
        if($location)
        {
...
<script type="text/javascript" src="{{ asset('js/searchPage.min.js') }}?v={{ filemtime(public_path('js/searchPage.min.js')) }}"></script>
<link rel="stylesheet"
