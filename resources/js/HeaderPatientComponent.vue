<template>
  <div>
    <header>
      <nav class="navbar navbar-expand navbar-light admin_header topbar static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img v-if="doctor.profile.avatar" :src="'/uploads/users/'+doctor.id+'/'+doctor.profile.avatar" class="img-profile rounded-circle" :alt="doctor.first_name +' '+ doctor.last_name">
          <img v-else :src="'/uploads/users/default/doctor.svg'" class="img-profile rounded-circle" alt="user Image">
