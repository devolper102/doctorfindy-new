<template>
  <div class="d-flex">
    <!--Start Sidebar-->
    <ul class="navbar-nav sidebar sidebar_dark accordion" style=" padding-top:0px;overflow-x: hidden;"id="accordionSidebar">
...
<!--         <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">
            ...
            <span>Inbox</span></a>
             ...
             <li class="nav-item">
          <a class="nav-link" href="/patient/all-appointments">
            <i class="fas fa-calendar-alt"></i>
     ...
     <!--    <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/patient/profile-settings">
     ...
     <!--    <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/patient/payout-setting">
