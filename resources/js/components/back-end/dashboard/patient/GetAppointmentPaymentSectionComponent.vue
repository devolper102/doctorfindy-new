                  ...
                  <div class="col-12 p-0">
                    <div class="row">
                      <div class="col-12 col-lg-4">
                        ...
                        <input type="text"v-model="appointment.patient_profile.first_name"  class="form-control" id="firstnameInputText" aria-describedby="emailHelp" placeholder="">
                        </div>
                      </div>
                      <div class="col-12 col-lg-4">
                        <div class="form-group  mb-lg-0 input-amount">
                        <label class="text_black mb-2 mt-2">Last name</label>
                        <input type="text" v-model="appointment.patient_profile.last_name"  class="form-control" id="lastnameInputText" aria-describedby="emailHelp" placeholder="">
                        </div>
                      </div>
              ...
              <div class="header_bg w-100 d-inline-block box_radius box_bottom_lr_radius position-relative p-2">
                        <div class=" doctor_image position-relative float-left mr-3">
                          <div class="book-dr-image mt-3 mt-lg-0 mb-3 mb-lg-0 float-left">
                            <img :src="'/uploads/users/'+appointment.user_id+'/'+appointment.doctor_profile.profile.avatar" :alt="appointment.doctor_profile.first_name" class="img-fluid rounded-circle h_50 w-50px modal_img">
                          </div>
                        </div>
                     <div class="prfile_detail mb-2">
                          <h5 class="d-inline-block font-weight-bold">
                          {{appointment.doctor_profile.first_name}} {{appointment.doctor_profile.last_name}}</h5>
                           <span class="ml-2">
                  ...
                  <p class="text_14 text_md_13 d-xs-none d-sm-none d-md-none d-lg-block">
                    {{ appointment.doctor_profile.profile.sub_heading }}</p>
                  ...
                  <div class="border-bottom-dark w-100 d-inline-block pb-2">
                    <div class="verification-text-phone-number pb-3">
                      <div class="patient_summary mb-2 overflow-hidden">
                        ...
                        <span class="float-right text-right text-lg-left w-50">{{appointment.appointment_time}}
                        </span>
                      </div>
                      <div class="patient_summary mb-2 overflow-hidden">
                        <span class="text_black font-weight-bold w-50 float-left"> <img src="/images/date-image.png" class="img-fluid mr-2"> Date
                        </span>
                        <span class="float-right text-right text-lg-left w-50">{{appointment.appointment_date | formatDate}}</span>
                      </div>
                      <div class="patient_summary mb-2 overflow-hidden">
                        ...
                        <span class="float-right w-50 text-right text-lg-left" v-if="appointment.hospital_id !== 0">{{appointment.hospital_profile.first_name}} {{appointment.hospital_profile.last_name }},{{appointment.hospital_profile.profile.address}}
                        </span>
                      ...
                      <div class="patient_summary mb-2 overflow-hidden">
                        ...
                        <span class="float-right w-50 text-right text-lg-left">{{appointment.charges}}</span>
                      </div>
                      <!-- <div class="patient_summary mb-2 overflow-hidden">
                ...
                <div class="modal-footer pb-0">
                  ...
                  text_13">
                    <div class="patient_summary">
                      ...
                      <span class="float-right w-50 text-right text-lg-left">Rs.{{appointment.charges}}</span>
                      </div>
                  </div>    
                </div>
              </div>
...
export default {
   components: {VTooltip},
  name: "GetAppointmentPaymentSectionComponent",
    props: ['appointment','patient','doctors','hospitals','managements'],
   data() {
    return {
      mode: "date",
  ...
  created () {
    console.log('find',this.appointment)
    this.education = JSON.parse(this.appointment.doctor_profile.profile.educations)
  },
   methods: {
    checkPatien(value) {
      console.log(value)
      ...
      first_name : this.appointment.patient_profile.first_name,
      last_name : this.appointment.patient_profile.last_name,
       ...
       charges : this.appointment.charges,
