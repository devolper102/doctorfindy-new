        ...
        dropzoneOptions: {
                ...
                transformFile: function (file, done) {
                  ...
                  buttonConfirm.addEventListener('click', function () {
                    ...
                    var watermarkScale = 0.3;
                    watermark.onload = function () {
                         var watermarkWidth = watermark.width * watermarkScale;
                         var watermarkHeight = watermark.height * watermarkScale;


                         var xPosition = (canvas.width - watermarkWidth) / 2;
                         var yPosition = canvas.height - watermarkHeight;

                         var centerMargin = 20; // You can adjust this value as needed
                         var bottomMargin = 10;
                         yPosition -= bottomMargin;

                         var canvasCenter = 256 / 2;
                         xPosition = canvasCenter - watermarkWidth / 2;
                      // Draw the watermark after it's loaded
                       ctx.drawImage(watermark, xPosition, yPosition - centerMargin, watermarkWidth, watermarkHeight);
                    ...
                    watermark.src = '/images/DoctorFindywatermark.png';
