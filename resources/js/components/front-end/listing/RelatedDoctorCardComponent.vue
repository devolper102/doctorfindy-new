      ...
      <div class="doctros_profiles">
        <div class="doctor_data d-inline-block w-100">
            <div class="doctor_image position-relative float-left w-20">
              ...
              <a :href="'/profile/'+doc.slug" class="circle_anchor position-absolute"></a>
            </div>
            ...
            w-75 mt-1">
              <div class="w-100 d-inline-block">
                <a class="text_black font-weight-bold w-75 d-inline-block text-truncate text_13" :href="'/profile/'+doc.slug">{{ doc.first_name }} {{ doc.last_name }}</a>
            ...
            <!-- <span v-else class="text_12 text_black d-block"> -->
              
              <!--<span v-for="spec in doctor.specialities">{{spec.title}} </span>-->
            <!-- </span> -->
            <p v-if="docFee(doc) > 0" class="text_12 text_black">Fee<strong v-if="doc.profile.fees_range === '' || doc.profile.fees_range === null || doc.profile.fees_range === 'null'"> Rs {{docFee(doc)}}</strong>
            <strong v-else>
  ...
  methods: {
    ...
    docFee(user){
      var docPrice = [];
        ...
        return Math.max.apply(Math, docPrice);
        }
        return 0;
      },
