  ...
  <div>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <!-- Popular labs -->
        <div v-if="this.labs.length > 0" class="w-100 d-inline-block mb-3">
            <div class="row">
              <div class="col-12">
            ...
            <div class="row">
              <div class="col-12">
                <ul class="disease-allergy-immunology w-100 d-inline-block patient-date">
                  <li v-for="(lab,index) in labs" v-if="index < 5" class=" mr-lg-3 mb-3 w-md-48 text-center float-left">
...
export default {
  ...
  props: ['labs','cities','specialities','cities_pakistan'],
}
</script>
