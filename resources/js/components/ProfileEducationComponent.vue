                            ...
                            <div class="dc-formtheme dc-userform">
                                <fieldset>
                                    <div class="form-group form-group-half">
                                        <input type="text" :value="stored_education.degree_title" v-bind:name="'education['+[index]+'][degree_title]'" class="form-control" :placeholder="degree_title" required>
                                    </div>
                                    <div class="form-group form-group-half">
                                        <date-pick v-model="stored_education.start_date"></date-pick>
                                        <input type="hidden" :value="stored_education.start_date" v-bind:name="'education['+[index]+'][start_date]'" class="form-control" :placeholder="ph_start_date" required>
                                    </div>
                                    <div class="form-group form-group-half">
                                        <date-pick v-model="stored_education.end_date"></date-pick>
                                        <input type="hidden" :value="stored_education.end_date" v-bind:name="'education['+[index]+'][end_date]'" class="form-control" :placeholder="ph_end_date" required>
                                    </div>
                                    <div class="form-group form-group-half">
                                        <input type="text" :value="stored_education.job_title" v-bind:name="'education['+[index]+'][job_title]'" class="form-control" :placeholder="ph_job_title" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea :value="stored_education.job_desc" v-bind:name="'education['+[index]+'][job_desc]'" class="form-control" :placeholder="ph_job_desc" required></textarea>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
                ...
                <div ref="educationlistelement" class="edu-inner-list-item dc-settingscontent">
                    ...
                    <div class="dc-collapseexp collapse hide" :id="'educationaccordioninner['+education.count+']'">
                        <div class="dc-formtheme dc-userform">
                            <fieldset>
                                <div class="form-group form-group-half">
                                    <input type="text" v-bind:name="'education['+[education.count]+'][degree_title]'" class="form-control" :placeholder="ph_degree_title" v-model="education.degree_title" required>
                                </div>
                                <div class="form-group form-group-half">
                                    <date-pick v-model="education.start_date"></date-pick>
                                    <input type="hidden" v-bind:name="'education['+[education.count]+'][start_date]'" :value="education.start_date" required>
                                </div>
                                <div class="form-group form-group-half">
                                    <date-pick v-model="education.end_date"></date-pick>
                                    <input type="hidden" v-bind:name="'education['+[education.count]+'][end_date]'" :value="education.end_date" required>
                                </div>
                                <div class="form-group form-group-half">
                                    <input type="text" v-bind:name="'education['+[education.count]+'][job_title]'" class="form-control" :placeholder="ph_job_title" required>
                                </div>
                                <div class="form-group">
                                    <textarea v-bind:name="'education['+[education.count]+'][job_desc]'" class="form-control" :placeholder="ph_job_desc" required></textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
