            ...
            <div v-bind:class="[index == 0 ? 'active' : '', 'dc-subpaneltitle dc-subpaneltitlevtwo']">
                ...
                <div class="dc-rightarea">
                    ...
                    <div class="dc-btnaction">
                        ...
                        :id="'childcollapse-edit-'+index+'-'+speciality_index" v-on:click="toggleChildCollapse('childcollapse-edit-'+index+'-'+speciality_index, 'childcollapse-'+index+'-'+speciality_index)">
        ...
        <div class="dc-subpanel" v-for="(new_service, index) in new_services" :id="'childcollapse-'+speciality_index+'-'+new_service.count+'-'+speciality_index" :key="'new_service'+index">
            <div v-bind:class="[new_service.count == 0 ? 'active' : '', 'dc-subpaneltitle dc-subpaneltitlevtwo']">
                ...
                <div class="dc-rightarea">
                    ...
                    <div class="dc-btnaction">
                        <a href="javascript:void(0);" class="dc-editbtn" 
                        :id="'childcollapse-edit-'+speciality_index+'-'+new_service.count+'-'+speciality_index" v-on:click="toggleChildCollapse('childcollapse-edit-'+speciality_index+'-'+new_service.count+'-'+speciality_index, 'childcollapse-'+speciality_index+'-'+new_service.count+'-'+speciality_index)">
                            <i class="lnr lnr-pencil"></i>
                        </a>
