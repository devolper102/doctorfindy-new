...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  actions: {
    // Specialities
    getSpecialities: function getSpecialities(_ref) {
      var commit = _ref.commit;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/all-spec", {}).then(function (response) {
        var specialities = response.data;
    ...
    getDoctors: function getDoctors(_ref2) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/all-docs", {}).then(function (response) {
    ...
    // Hospitals
    getHospitals: function getHospitals(_ref3) {
      var commit = _ref3.commit;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/all-hosp", {}).then(function (response) {
    ...
    // Diseases
    getDiseases: function getDiseases(_ref4) {
      var commit = _ref4.commit;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/all-dise", {}).then(function (response) {
    ...
    // Laboratories
    getLaboratories: function getLaboratories(_ref5) {
      var commit = _ref5.commit;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/all-labs", {}).then(function (response) {
        var laboratories = response.data;
    ...
    // Services
    getServices: function getServices(_ref6) {
      var commit = _ref6.commit;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/all-services", {}).then(function (response) {
  ...
  getters: {
    specialitiesData: function specialitiesData(specialities) {
      return state.specialities;
    },
    doctorsData: function doctorsData(doctors) {
      return state.doctors;
    },
    hospitalsData: function hospitalsData(hospitals) {
      return state.hospitals;
    },
    diseasesData: function diseasesData(diseases) {
      return state.diseases;
    },
    laboratoriesData: function laboratoriesData(laboratories) {
      return state.laboratories;
    },
    servicesData: function servicesData(services) {
    ...
    computerData: function computerData(state) {
      return state.computers;
    },
    //something like this?
    getComputerbyID: function getComputerbyID(state, id) {
      return function (id) {
        return state.computers.find(function (computer) {
          return computer.Site === site.id;
        });
      };
    }
  },
  mutations: {
    ...
    SET_COMPUTERS: function SET_COMPUTERS(state, computers) {
...
module.exports = __webpack_require__(/*! C:\laragon\www\doctorfindy-new\resources\js\store.js */"./resources/js/store.js");
